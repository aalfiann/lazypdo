...
use PDO;
    /**
     * A class to make lazy load PDO connection to database
     *
     * @package    aalfiann/lazypdo
     * @author     M ABD AZIZ ALFIAN <github.com/aalfiann>
     * @copyright  Copyright (c) 2019 M ABD AZIZ ALFIAN
     * @license    https://github.com/aalfiann/lazypdo/blob/master/LICENSE.md  MIT License
     */
